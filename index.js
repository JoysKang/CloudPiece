...
var notion = new Client({ auth: Config.relationCode });
function getUserData(chatId) {
    return __awaiter(this, void 0, void 0, function () {
        var response, databaseId, accessToken, pageId;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [2 /*return*/, [databaseId, accessToken, pageId]];
            }
        });
    });
}
(function () { return __awaiter(_this, void 0, void 0, function () {
    var _a, databaseId, accessToken, pageId;
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, getUserData("682824243")];
            case 1:
                _a = _b.sent(), databaseId = _a[0], accessToken = _a[1], pageId = _a[2];
